...
*/
function reflectedRayStartEnd(xPrevious, slope1, yint1){
    let [a,b,c] = parab1;
    let [a2,b2,c2] = parab2;
    ...
    console.log("SLope 2",slope2, "yint2: ",yint2);
...
function reflectedRay(xPrevious, parab_1, parab_2, slope1, yint1, points){
    ...
    let [sX, sY, eX, eY, slope2, yint2] = reflectedRayStartEnd(xPrevious, slope1, yint1);
    
    console.log("Values: ", sX, sY, eX, eY, slope2, yint2);
    ...
    // const tS = -1/(2 * a * myXStart + b);
    // m = (slope * tS * tS + 2 * tS - slope)/(2* slope *tS - tS*tS + 1);
    // newY = y2 - m*myXStart;

    // if (myXStart < xPrevious){
    //     console.log("myXStart", myXStart);
    //     for (let x = myXStart; x <= maxX; x+=0.01){
    //         const y = m*(x-myXStart) + y2;
    //         points.push({x,y});
    //     }
    // } else {
    //     console.log("Second myXStart", myXStart);
    //     for (let x = myXStart; x >= minX; x-=0.01){
    //         const y = m*(x-myXStart) + y2;
    //         points.push({x,y});
    //     }
    // }
...
function updateGraph() {
    ...
    let [sX2, slope2, yint2] = reflectedRay(minX, parab0, parab1, slope, yint, reflectedPts);
    //let [sX3, slope3, yint3] = reflectedRay(sX2, parab1, parab2, slope2, yint2, reflectedPts2);
